...
print('50 ŽELVICEK DO NÁHODNÝCH BODŮ')
print('''pouze k zobrazení - program vyrobí 50 želviček na náhodných
pozicí a pak je nechá v každém cyklu zbýhat k jinému
náhodně vygenerovanému bodu.''')
print()
...
def smerom(seznam, poz):                            #definice funkce - pro pohyb 'želvých' per (seznam, souřadnice směru)
    for i in range(20):                                 #cyklus - 50x zopakuj
        x2 = random.randint(-300, 300)                      #proměnná - generování hodnoty 'x1'
        y2 = random.randint(-300, 300)                      #proměnná - generování hodnoty 'y1'
...
poz = (0, 0)                                        #proměnná - pro souřadnice pozice, kam pera směřují
vyrob(50, poz)                                      #volání funkce - na výrobu želvých per (počet, směr)
