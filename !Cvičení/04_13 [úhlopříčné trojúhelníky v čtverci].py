##Podobná úloha ako v predchádzajúcom príklade, len v tomto sa využívajú uhlopriečky štvorca.
...
print('UHLOPŘÍČNÉ TROJÚHELNÍKY V ČTVERCI')
print('program vytečkuje do čtvercového pozadí 4 rovnoramené trojúhelníky, každý jinou barvou')
print()
